...
function renderquest(){    
            ...
            <div class="container" style="margin: 0px auto; ">
                <h5 class= "py-3">${crntquestion+1}- ${quiz[quizname][crntquestion].question}</h5>
            <input type="radio" value="${quiz[quizname][crntquestion].option1}" name="options" id="opt1" class="my-2">
            <label class="my-2" for="opt1">${quiz[quizname][crntquestion].option1}</label><br>
            <input type="radio" value="${quiz[quizname][crntquestion].option2}" name="options" id="opt2" class="my-2">
            <label class="my-2" for="opt2">${quiz[quizname][crntquestion].option2}</label><br>
            <input type="radio" value="${quiz[quizname][crntquestion].option3}" name="options" id="opt3" class="my-2">
            <label class="my-2" for="opt3">${quiz[quizname][crntquestion].option3}</label><br>
            <input type="radio" value="${quiz[quizname][crntquestion].option4}" name="options" id="opt4" class="my-2">
            <label class="my-2" for="opt4">${quiz[quizname][crntquestion].option4}</label>

            <div id="button" class="button my-5  text-start">
            <button onclick="btnFunc()" class="text-white" style="background-color: rgba(1,46,113,255); margin: 0px auto;">
                Next Question
            </button>
        </div>
            </div>
